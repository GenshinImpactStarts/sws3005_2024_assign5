...
vec4 plane( in int idx )
{
    switch(idx) {
        ...
        case 5: return vec4( 1.0, 0.0, 1.0, 10.0 );
        case 6: return vec4( 1.0, 0.0, -1.0, 10.0 );
        case 7: return vec4( -1.0, 0.0, 1.0, 10.0 );
        case 8: return vec4( -1.0, 0.0, -1.0, 10.0 );
    }
}
...
vec4 triangle( in int frame, in int idx )
{
    switch(frame) {
        case 0:
            switch(idx) {
